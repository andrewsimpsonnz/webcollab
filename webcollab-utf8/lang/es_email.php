...
$email_welcome = "Bienvendio,\n\nHa sido dado de alta en: ".MANAGER_NAME." el ".$email_date.".\n\n".
"Estas son unas notas de presentacion para los nuevos usuarios de nuestra aplicacion de gestion de proyectos.\n\n".
"Lo primero es ir a la herramienta de gestion de proyectos. En la pantalla principal aparecen los proyectos actualmente disponibles. ".
"Al pinchar con el raton en uno de los proyectos se accede a las tareas asociadas a ese proyecto.\n\n".
"Cada item que se envia o tarea que edita se muestra al resto de usuarios como 'nueva' o 'actualizada'. Esto permite identificar rapidamente".
"en las actividades que se estan realizando en cada proyecto.\n\n".
"Puede hacerse cargo o propietario de las tareas, obteniendo permisos para editarlas. Tambien recibira los envios al foro. ".
...
"\n\nEsperamos que la herramienta sea de su agrado. Envie email a ".EMAIL_ADMIN." si tiene alguna duda.\n\n --Buena suerte!\n\n".
"Login: %1\$s\n".
"Password: %2\$s\n\n".
...
"Si olvido su clave envie un email ".EMAIL_ADMIN." para solicitar una nueva clave.";
