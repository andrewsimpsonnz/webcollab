...
$taskgroup_info =   "<ul><li>Hvis du sletter en opgavegruppe, vil alle opgaver i den blive ændret til ikke-kategoriseret</li>\n".
                      "<li>Du kan ændre navn på kategori uden indflydelse på opgaver</li>\n".
                      "<li>To opgavegrupper kan ikke have samme navn</li></ul>\n";

$usergroup_info =   "<ul><li>Hvis du sletter en brugergruppe vil alle tilhørende private forum-poster blive slettet</li>\n".
                      "<li>Du kan ændre navnet på en brugergruppe uden indflydelse på brugerne i den.</li>\n".
                      "<li>To brugergrupper kan ikke have det samme navn.</li></ul>\n";

$user_info      =    "Vælg handling i menuen til venstre.<br /><br />".
                      "Nogle hurtige vink:<br />".
                      "<ul>".
                      "<li> Private brugere kan kun ses af medlemmer af den same brugergruppe.</li>\n".
...
$calendar_key    =  "<i>Tilbage til hovedmenu</i></a>]</b><br />\n".
                      ...
                      "<span class=\"green\"><u>Projekt </u>(alle opgaver afsluttet.)</span><br />\n".
