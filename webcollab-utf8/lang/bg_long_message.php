...
$taskgroup_info     =   "<ul>\n".
                            "<li>Ако изтриете група задачи всички задачи пронадлежащи към тази група ще бъдат прехвърлени като <i>[без група]</i>.</li>\n".
...
$usergroup_info     =   "<ul>\n".
                            ...
                            "<li>Можете да преименувате потребиталската група без това да се отрази на нейните членове.</li>\n".
                            "<li>Не може да име две потребителски групи с еднакви имена.</li>\n".
                        "</ul>\n";

$user_info          =    "Моля изберете действие от менюто вляво.<br /><br />".
                      "Подсказки:<br />".
                          "<ul>".
                              //**
                              "<li>Поверителни потребители могат да бъдат виждани само от членове на същата потребителска груа.</li>\n".
                              ...
                              "<li><b>Всички</b> действия по пормяна на потребител ще мъ бъдат съобщавани по неговата е-Поща.</li>\n".
                              "<li>Паролите са записани кодирани в базата от данни. Могат само да бъдат сменяни.</li>\n".
                              "<li>Паролите се изпращат само веднъж по е-Пощата, когато поребителя бъде създаден, за това бъдете внимателни къде я изпращате!</li>\n".
                              "<li>Потребителите могат да се променят сами без знанието на администратора - това е с цел пестене на време</li>\n".
                          "</ul>\n";
