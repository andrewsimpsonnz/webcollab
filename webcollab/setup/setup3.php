...
'     ============================'."\n\n".
'  Automatically generated by the setup program on '.date("D M j G:i:s T Y")."\n\n".
'*/'."\n\n".
...
'  $WEB_AUTH = "N";'."\n".
'  //Change the line below to "N" to allow web-based configuration of this file (Defaults to "Y" after first web install)'."\n".
'  $SETUP_COMPLETE = "Y";'."\n".
"?>\n";
...
new_box_setup("Setup - Stage 3 of 3", $content, "boxdata", "singlebox" );
