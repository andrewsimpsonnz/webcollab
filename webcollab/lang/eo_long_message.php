...
$taskgroup_info =   "<ul><li>Se vi forigas taskogrupon, iliaj taskoj iøos sengrupaj.</li>\n".
                      "<li>La nomo de taskogrupo estas þanøebla sen influi la arojn de taskoj en øi.</li>\n".
                      "<li>Ne povas ekzisti du taskogrupojn kun sama nomo.</li></ul>\n";

$usergroup_info =   "<ul><li>Se vi forigas uzantogrupon, æiuj al øi apartenantaj privataj forumaj mesaøoj ankaý malaperos.</li>\n".
                      "<li>Privataj uzantgrupoj nur estas videbla de membroj de tiuj grupoj (kaj administrantoj).</li>\n".
                      "<li>La nomo de uzantgrupo estas þanøebla sen influi la aron de uzantoj en øi.</li>\n".
...
$user_info      =    "Bonvolu elekti agon el la menuo maldekstre.<br /><br />".
                      ...
                      "<li>Uzantoj havas du statoj de <em>forigiteco</em> - la dua estas daýra (nerenversigebla).</li>\n".
                      "<li>Forigita uzanto perdas siajn Taskojn, sed ne la forumajn mesaøojn.</li>\n".
                      "<li>Daýre forigita uzanto perdis æion.</li>\n".
                      "<li>Forigita uzanto tenas la vid-rajtojn de videblaj taskoj, kaj rericevas ilin post revigigo.</li>\n".
                      "<li><em>Æiuj</em> Agoj, kiujn vi faras pri uzanto, estos senditaj al li per retpoþto.</li>\n".
                      "<li>La pasvortoj estas kriptitaj en la datumbazo, do ne eblas eltrovi ilin. Vi nur povas disdoni novajn.</li>\n".
                      "<li>La pasvortoj estos post þanøo sendataj (unufoje) al la uzanto - do atentu pri la retpoþtadreso.</li>\n".
                      "<li>Uzantoj povas redakti sin mem, sen ke administrantoj ekscias pri tio. Tio þparos tempon (kaj tro da retmesaøoj).</li>\n".
                      "</ul>\n";
