...
//contacts
 ...
 "session_timeout_sprt" => "Acc&egrave;s denegat, la &uacute;ltima acci&oacute; va ser fa %d i el temps d'expiració &eacute;s de 60 minuts, si us plau <A href=\"%sindex.php\">Identifiqui's</A>",
 "ip_spoof_sprt" =>"IP Spoofejada detectada des de la seva ip (%s) aquesta sessió ha estat esborrada per precaució, si us plau <A href=\"%sindex.php\">torni a entrar</A>",
 ...
 "taskgroup_manage" => "Administració de Taskgroups",
...
//**
 ...
 "invalid_email" => "Adreça mail no v&agrave;lida",
 "invalid_email_given_sprt" => "L'adreça email '%s' no &eacute;s correcta. Si us plau, torni enrera i reintenti-ho.",
 ...
 "all_users" => "Tots els usuaris poden veure aquesta tasca?",
