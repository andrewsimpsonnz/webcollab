...
//contacts
 ...
 "session_timeout_sprt" => "Acc&egrave;s denegat, la &uacute;ltima acci&oacute; va ser fa %d i el temps d'expiraci &eacute;s de 60 minuts, si us plau <A href=\"%sindex.php\">Identifiqui's</A>",
 "ip_spoof_sprt" =>"IP Spoofejada detectada des de la seva ip (%s) aquesta sessi ha estat esborrada per precauci, si us plau <A href=\"%sindex.php\">torni a entrar</A>",
 ...
 "invalid_email" => "Adre&iuml;申 mail no v&agrave;lida",
 "invalid_email_given_sprt" => "L'adre&iuml;申 email '%s' no &eacute;s correcta. Si us plau, torni enrera i reintenti-ho.",
 ...
 "completed" => "Complert",
 "project_hold" => "Projecte susp&egrave;s des de ",
 "project_planned" => "Projecte planejat",
 "percent" => "% de tasques fetes",
 ...
 "usergroup_can_edit_sprt" => "Aquest %s tamb&iuml;申pot ser editat pels membres del usergroup.",
 "i_take_it" => "L'agafo jo :)",
 "i_finished" => "L'he acabat!",
 "i_dont_want" => "No el vui m&eacute;s",
 "take_over_sprt" => "Prendre el control %s",
