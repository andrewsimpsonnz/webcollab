...
$title_takeover_project  = ABBR_MANAGER_NAME.": Новый координатор Вашего проекта";
$title_takeover_task     = ABBR_MANAGER_NAME.": Новый координатор вашего задания";
...
$email_welcome      = "Здравствуйте,\n\nСистема ".MANAGER_NAME." приветствует Вас. ".$email_date.".\n\n".
			...
			"При выполнении работ над проектом или зданием не забывайте изменять его статус и описание в зависимости от ситуации, ".
			"это позволит другим участникам проекта корректировать свою работу, ну и, конечно, от этого зависит ход работ над всем проектом в целомr. ".
