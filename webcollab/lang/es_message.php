...
$lang = array(
 ...
 "delete" => "Borrar",
 "del" => "Borra",
 "confirm_del_javascript" => "Confirma borrado!",
 "yes" => "Si",
 "no" => "No",
 "action" => "Accion",
 "task" => "Tarea",
...
//contacts
 ...
 "file" => "Archivo:",
 "uploader" => "Uploader:",
 "files_assoc_project" => "Archivos asociados con proyecto",
 "files_assoc_task" => "Archivos asociados con tarea",
...
// "no_session" => "Sesi&oacute;n inexistente, por favor <a href=\"%sindex.php\">Ingrese</A>",
 ...
 "by_sprt" => "%1\$s por %2\$s", //Note to translators: context is 'Creation time: <date> by <user>'
