...
$email_welcome      = "Hola,\n\nAquest &eacute;s el lloc %s donant-li la benvinguda ;) el  %s.\n\n".
			...
			"A mesura que avança en la seva feina, per favor editi el text de les seves tasques i l'estat de tal forma que tothom pugui mantenir un seguiment del seu progr&eagrave;s. ".
