...
//dates
$month_array = array ( NULL, "Jan", "Fév", "Mar", "Avr", "Mai", "Jui", "Jul", "Aoû", "Sep", "Oct", "Nov", "Dec" );
...
//task states
 ...
 //status
    ...
    $task_state['task_planned']           = "Planifiée";
...
//common items
    ...
    $lang['info']                         = "Info";
    $lang['bytes']                        = " octets";
    $lang['select_instruct']              = "(Utiliser CTRL pour faire de multiples sélections ou aucune sélection)";
...
//admin config
    ...
    $lang['email_settings']               = "Paramètre en-tête du Courriel";
    ...
    $lang['allow_group_edit']             = "Autoriser l'édition pour tous les membres du groupe d'utilisateurs ?";
...
//contacts
    ...
    $lang['show_contact']                 = "Afficher les contacts";
    $lang['edit_contact']                 = "Editer les contacts";
    $lang['contact_submit']               = "Modifier le contact";
 ...
 //files
    ...
    $lang['no_files']                     = "Aucun fichier téléchargé à gérer";
 ...
 //forum
    ...
    $lang['search_results']               = "Trouvé %1\$s résultat(s) pour '%2\$s'<br />Affiche résultat(s) %3\$s à %4\$s";

 //includes
    $lang['report']                       = "Rapport";
    $lang['warning']                      = "<h1>Désolé!</h1><p>Nous sommes incapables de procéder à votre requête actuellement. Veuillez réessayer plus tard.</p>";
    $lang['home_page']                    = "Page Principale";
    $lang['summary_page']                 = "Sommaire";
    $lang['log_out']                      = "Déconnection";
    $lang['main_menu']                    = "Menu Principal";
    $lang['archive']                      = "Archive";
    $lang['user_homepage_sprt']           = "Profil : %1\$s";
    ...
    $lang['session_timeout_sprt']         = "Accés refusé, la dernière action a été faite il y à %1\$d minutes. Le temps imparti pour une session est de %2\$d minutes, merci de vous  <a href=\"%3\$sindex.php\">reconnecter</a>";
 ...
 //taskgroups
    ...
    $lang['manage_taskgroups']            = "Gestion du groupe de tâches";
...
//** needs translation
    $lang['email_new_usergroup']          = "Envoyer les nouveaux détails au groupe d'utilisateurs ?";
    $lang['email_edit_usergroup']         = "Envoyer les changements au groupe d'utilisateurs ?";
 ...
 //users
    ...
    $lang['is_guest']                     = " est un invité";
    $lang['guest']                        = "Invité";
    $lang['user_info']                    = "Information utilisateur";
    $lang['deleted_users']                = "Utilisateurs effacés";
    $lang['no_deleted_users']             = "Il n'y aucun utilisateur effacé.";
    $lang['revive']                       = "Réactiver";
    $lang['permdel']                      = "Effacer permament";
    $lang['permdel_javascript_sprt']      = "Ceci va effacer de manière permanente toutes les informations d'un utilisateur et ses tâches associées pour %1\$s. Voulez-vous réellement le faire ?";
    $lang['add_user']                     = "Ajouter un utilisateur";
    $lang['edit_user']                    = "Editer un utilisateur";
    $lang['no_users']                     = "Utilisateur inconnu de ce site !";
    $lang['users']                        = "Utilisateurs";
    $lang['existing_users']               = "Utilisateurs existants";
    $lang['private_profile']              = "Vous ne pouvez voir le profil privé de cet utilisateur.";
    ...
    $lang['select_usergroup']             = "Utilisateurs sélectionnés parmi les groupes ci-dessous :";
    $lang['subject']                      = "Sujet";
    ...
    $lang['edit_details']                 = "Editer les infos utilisateur";
    $lang['show_details']                 = "Afficher les infos utilisateur";
    ...
    $lang['owned_tasks']                  = "Tâche(s) à sa charge:";
  ...
  //tasks
    ...
    $lang['taskgroup']                    = "Groupe de tâches";
    $lang['usergroup']                    = "Groupe d'utilisateurs";
    ...
    $lang['due_sprt']                     = "Il reste %d jours";
    ...
    $lang['project_options']              = "Options du rojet";
    $lang['task_options']                 = "Options de la tâche";
    ...
    $lang['no_allowed_projects']          = "Aucun projet que vous soyez autorisé à afficher";
    ...
    $lang['task_info']                    = "Information sur la tâche ";
    $lang['project_details']              = "Détails du projet";
    $lang['todo_list_for']                = "Tâche(s) à faire pour : ";
    ...
    $lang['task_submit']                  = "Modifier la tâche";
    $lang['not_owner']                    = "Accès refusé, soit vous n'en êtes pas le propriétaire, soit vous n'avez pas de droit dessus";
    $lang['missing_values']               = "Il y a des champs non renseignés, merci de revenir en arrière et d'essayer à nouveau";
    $lang['future']                       = "Futur";
...
//**
    $lang['url_javascript']               = "Entrer l'URL :";
//**
    $lang['image_url_javascript']         = "Entrer l'URL de l'image:";
