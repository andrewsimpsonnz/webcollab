...
$lang = array(
 ...
 "delete" => "Effacer",
 "del" => "Eff",
 "confirm_del" => "Confirmer l'effacement!",
 "yes" => "Oui",
 "no" => "Non",
 "action" => "Action",
 "task" => "T&acirc;che",
...
//**
 ...
 "session_timeout_sprt" => "Acc&eacute;s refus&eacute;, la derni&egrave;re action a &eacute;t&eacute; faite il y &agrave; %1\$d minutes et la session s'est ferm&eacute;e apr&egrave;s 60 minutes, merci de vous  <A href=\"%sindex.php\">re-connecter</A>",
