...
$email_edit_group_project   = $email_commom_header . " бе променен проект пронадлежащ на %s.\n\nЕто детайлите:\n\n";
$email_edit_group_task      = $email_commom_header . " бе променена задача пронадлежаща на %s.\n\nЕто детайлите:\n\n";
...
$email_welcome              = "    Здравейте,\n\n    Това писмо е от страницата на " . MANAGER_NAME . ", приветстваща Ви с добре дошли на " . $email_date . ".\n\n".
                                "Тъй като Вие сте нови тук, аз ще Ви обясня няколко неща, така че да можете бързо да започнете работа.\n\n".
                                "Най-напред, това е инструмент на ръководене на проекти, главната страница ще ви покаже проектите, които в момента са налични. ".
                                "Ако кликнете на някое от имената ще бъдете препратени в частта за задачите. Това е мястото, където се работи.\n\n".
                                "Всеки елемент, който вие изпращате или задача която разработвате ще бъде показвана на другите потребители като \"НОВО\" или \"ОБНОВЕНО\". Същото важи и за задачите на другите потребители и така Вие ще можете бързо де се ориентирате къде се работи активно. ".
                                "Също така Вие можете да завзимате или да получавате собственост върху задачи и ще можете да ги редактирате, а също и мненията към тях в принадлежащия форум. ".
...
$title_user_change2         = ABBR_MANAGER_NAME . ": Промяна на Вашия акаунт";
                              "    Здравейте,\n\n    Това писмо е от страницата на " . MANAGER_NAME . ", потвърждаващо че промените, които се направили на " . $email_date . " по акаунта си са успешни.\n\n";
                                "Вход:      %1\$s\n".
                                "Парола:    %2\$s\n\n".
                                "Име:       %3\$s\n";
...
$email_revive               = $email_commom_header . " Вашият акаунт бе възстановен.\n\n".
                                "Вход:  %1\$s\n".
                                "Име:   %2\$s\n\n".
                                "Не изпращане паролата Ви, защото е кодирана. \n\n".
