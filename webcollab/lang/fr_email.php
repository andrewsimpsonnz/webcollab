...
$email_file_post          = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'un nouveau fichier a été ajouté le ".$email_date." par %1\$s.\n\n".
                            "Fichier:        %2\$s\n".
                            "Description: %3\$s\n\n".
                            "Projet:         %4\$s\n".
                            "Tâche:          %5\$s\n\n".
...
$email_forum_post         = "Bonjour,\n\nLe site ".MANAGER_NAME." qui vous informe qu'un nouveau message a été ajouté le ".$email_date." par %1\$s:\n\n".
                            "----\n\n".
                            "%2\$s\n\n".
                            "----\n\n".
                            "Merci de consulter le site pour plus de détails.\n\n".BASE_URL."%3\$s\n";

$email_forum_reply        = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'un nouveau message a été ajouté le ".$email_date." par %1\$s.\n\n".
...
$email_takeover_project   = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que le projet a été assigné le ".$email_date." par l'administrateur.\n\n";

$title_takeover_task      = ABBR_MANAGER_NAME.": Votre tâche a été affectée."; // You item taken over
$email_takeover_task      = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que tâche a été assignée le ".$email_date." par l'administrateur.\n\n";

$title_new_owner_project  = ABBR_MANAGER_NAME.": Actualité de vos projets";
$email_new_owner_project  = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'un projet qui vous appartient a été modifié le ".$email_date.".\n\nPlus de détails :\n\n";

$title_new_owner_task     = ABBR_MANAGER_NAME.": Actualité de vos tâches";
$email_new_owner_task     = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que qu'une tâche qui vous appartient a été modifiée le ".$email_date.".\n\nPlus de détails :\n\n";

$title_new_group_project  = ABBR_MANAGER_NAME.": Nouveau projet :  %1\$s";
$email_new_group_project  = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'un nouveau projet a été créé le ".$email_date.".\n\nPlus de détails :\n\n";

$title_new_group_task     = ABBR_MANAGER_NAME.": Nouvelle tâche : %1\$s";
$email_new_group_task     = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'une nouvelle tâche a été créée le ".$email_date.".\n\nPlus de détails :\n\n";

$title_edit_owner_project = ABBR_MANAGER_NAME.": Mise à jour de votre projet";
$email_edit_owner_project ="Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que votre projet a été modifié le ".$email_date.".\n\nPlus de détails :\n\n";

$title_edit_owner_task    = ABBR_MANAGER_NAME.": Mise a jour de votre tâche";
$email_edit_owner_task    ="Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que tâche a été modifiée le ".$email_date.".\n\nPlus de détails :\n\n";

$title_edit_group_project = ABBR_MANAGER_NAME.": Mise à jour d'un projet";
$email_edit_group_project = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'un projet détenu par %1\$s a été modifié le ".$email_date.".\n\nPlus de détails :\n\n";

$title_edit_group_task    = ABBR_MANAGER_NAME.": Mise à jour d'une tâche ";
$email_edit_group_task    = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe qu'une tâche détenue par %1\$s a été modifiée le ".$email_date.".\n\nPlus de détails :\n\n";

$title_delete_project     = ABBR_MANAGER_NAME.": Projet supprimé";
$email_delete_project     = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que projet a été effaçé le ".$email_date.".\n\n".
                            "Merci d'avoir géré ce projet jusque-là.\n\n";

$title_delete_task        = ABBR_MANAGER_NAME.": Tâche supprimée";
$email_delete_task        = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que votre tâche a été effaçée le ".$email_date.".\n\n".
                            "Merci d'avoir géré cette tâche jusque-là.\n\n";
...
$email_usergroup_add      = "Bonjour,\n\n".
                            "Le site ".MANAGER_NAME." vous informe qu'un nouveau groupe d'utilisateurs %1\$s, a été créé le ".$email_date.".\n\n".
                            "Les membres du nouveau groupe d'utilisateurs sont :\n".
                            "%2\$s\n";

$title_usergroup_edit      = ABBR_MANAGER_NAME.": Usergroup %1\$s changed";
$email_usergroup_edit      = "Bonjour,\n\n".
                            "Le site ".MANAGER_NAME." vous informe que le groupe d'utilisateurs %1\$s, a été modifié le ".$email_date.".\n\n".
                            "Les membres du groupe d'utilisateurs sont :\n".
                            "%2\$s\n";

$title_welcome            = "Bienvenue ".ABBR_MANAGER_NAME;
$email_welcome            = "Bonjour,\n\nLe site ".MANAGER_NAME." vous accueille le ".$email_date.".\n\n".
                            "Si vous êtes débutant, voici quelques astuces de prise en main du site :\n\n".
                            "C'est un outil de gestion de projet. L'écran principal vous montre les projets qui sont actuellement gérés. ".
                            "Si vous cliquez sur un des noms de projet, vous listez ses tâches. Toutes les informations sont là. ".
                            ...
                            "Cela vous permet de connaître constamment où en est la réalisation de l'activité.\n\n".
                            "Vous pouvez aussi devenir propriétaire d'une tâche. Etre propriétaire d'une tâche vous permet d'éditer cette tâche et toutes contributions qui lui sont rattachées. ".
                            "Renseigner la partie de texte et le statut des tâches permet à tout le monde de connaître leurs progressions. ".
                            "\n\nBonne découverte, et voici mon email ".EMAIL_ADMIN." en cas de problème.\n\n --Bonne chance !\n\n".
                            "Profil:       %1\$s\n".
                            "Mot de passe: %2\$s\n\n".
                            "Groupe:       %3\$s".
                            "Nom:          %4\$s\n".
...
$email_user_change1       = "Bonjour,\n\nLe site  ".MANAGER_NAME." vous informe que votre profil a été modifié le ".$email_date." par %1\$s ( %2\$s ).\n\n".
                            "Login:        %3\$s\n".
                            "Mot de passe: %4\$s\n\n".
                            "Groupe:       %5\$s".
                            "Nom:          %6\$s\n\n".
...
$email_user_change2       = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que vous avez correctement modifié votre profil le ".$email_date.".\n\n".
                            "Profil:       %1\$s\n".
                            "Mot de passe: %2\$s\n\n".
                            "Nom:          %3\$s\n";
...
$email_revive             = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que votre profil a été réactivé le ".$email_date.".\n\n".
                            "Profil: %1\$s\n".
...
$email_delete_user        = "Bonjour,\n\nLe site ".MANAGER_NAME." vous informe que votre profil a été désactivé le ".$email_date."\n\n".
