...
$title_takeover     = $ABBR_MANAGER_NAME.": Votre info a &eacute;t&eacute; assign&eacute;"; // You item taken over
$email_takeover     = "Bonjour,\n\nC'est le site %s qui vous informe que %s a &eacute;t&eacute; assign&eacute; par l'administrateur sur %s.\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
...
$title_new_owner    = $ABBR_MANAGER_NAME.": Actualit&eacute;  %s pour vous";
$email_new_owner    = "Bonjour,\n\nC'est le site %s qui vous informe que %s vous (actuellement) &eacute;t&eacute; assign&eacute; %s.\n\nPlus de d&eacute;tails:\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
			"Status:   %s\n\n".
			"Texte: \n%s\n\n".
...
$title_new_group    = $ABBR_MANAGER_NAME.": Actualit&eacute; %s: ";
$email_new_group    = "Bonjour,\n\nC'est le site %s qui vous informe que une actualit&eacute; %s a &eacute;t&eacute; cr&eacute;&eacute;e pour %s\n\nPlus de d&eacute;tails:\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
...
$email_edit_owner   ="Bonjour,\n\nC'est le site %s qui vous informe que %s a &eacute;t&eacute; chang&eacute; %s.\n\nPlus de d&eacute;tails:\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
			"Status:   %s\n\n".
			"Texte: \n%s\n\n".
...
$title_edit_group   = $ABBR_MANAGER_NAME.": Mise &agrave; jour de %s ";
$email_edit_group   = "Bonjour,\n\nC'est le site %s qui vous informe que %s sur %s a &eacute;t&eacute; modifi&eacute; %s.\n\nPlus de d&eacute;tails:\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
			"Status:   %s\n\n".
			"Texte: \n%s\n\n".
...
$email_delete_task  = "Bonjour,\n\n".
			"C'est le site %s qui vous informe que %s a &eacute;ffac&eacute; %s\n\n".
			"Projet:  %s\n".
			"Tache:     %s\n".
			"Status:   %s\n\n".
			"Texte: \n%s\n\n".
...
$email_welcome      = "Bonjour,\n\nC'est le site %s qui vous acceuille sur %s.\n\n".
			...
			"cela vous permet de v&eacute;rifier où l'activit&eacute; se situe.\n\n".
