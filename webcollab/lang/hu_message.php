...
//admin config
    ...
    $lang['mailing_list']               = "Levelezõ lista";
...
//contacts
 ...
 //forum
    ...
    $lang['post']                       = "Elküldés!";
    $lang['message']                    = "Üzenet:";
    $lang['post_reply_sprt']            = "Válasz küldése '%1\$s' üzenetére a következõrõl: '%2\$s'";
    ...
    $lang['search_results']             = "A '%2\$s' kifejezésre %1\$s találat van.<br />Kilistázás a %3\$s.  elemtõl a %4\$s. elemig";
 ...
 //includes
    ...
    $lang['security_manager']           = "Biztonság-kezelõ";
    ...
    $lang['private_usergroup']          = "Sajnálom; ez a terület egy zárt felhasználói csoporthoz tartozik és nincs engedélye.";
    $lang['invalid_date']               = "Érvénytelen dátum";
    $lang['invalid_date_sprt']          = "A %s dátum nem egy érvényes naptár-dátum (Ellenõrizze a hónap napjainak számát).<br />Kérem lépjen vissza és adjon meg egy érvényes dátumot.";
 ...
 //users
    ...
    $lang['existing_users']             = "Létezõ felhasználók";
    ...
    $lang['duplicate_user']             = "Felhasználó megkettõzése";
    ...
    $lang['field_sprt']                 = "A '%s' mezõ üres. Kérem lépjen vissza és adja emg az értékét.";
  ...
  //tasks
    ...
    $lang['deadline']                   = "Határidõ";
    $lang['taken_from_parent']          = "(Öröklés a szülõtõl)";
    $lang['status']                     = "Állapot";
    ...
    $lang['due_today']                  = "Mára";
    $lang['overdue_1']                  = "1 nappal késõbbre";
    $lang['overdue_sprt']               = "%d nappal késõbbre";
    $lang['edit_task']                  = "Feladat szerkesztése";
    $lang['edit_project']               = "Projekt szerkesztése";
    $lang['no_reparent']                = "Egyik sem (egy felsõ szintû projekt)";
    ...
    $lang['project_hold_sprt']          = "Projekt felfüggesztése ettõl: %s";
    ...
    $lang['project_accessible']         = "(Ez a projekt nyilvánosan elérhetõ minden felhasználó által)";
    $lang['task_accessible']            = "(Ez a feladat nyilvánosan elérhetõ minden felhasználó által)";
    $lang['project_not_accessible']     = "(Ez a projekt csak a felhasználói csoport tagjai számára elérhetõ)";
    $lang['task_not_accessible']        = "(Ez a feladat csak a felhasználói csoport tagjai számára elérhetõ)";
    ...
    $lang['missing_values']             = "Nincs elég mezõ kitöltve, kérem lépjen vissza és töltse ki õket!";
    $lang['future']                     = "Jövõ";
    $lang['flags']                      = "Zászlók";
    ...
    $lang['by_deadline']                = " (határidõ által)";
