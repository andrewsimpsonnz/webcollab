...
$taskgroup_info =   "<ul><li>Eðer bir görev grubunu silerseniz ona ait tüm görevler kategorisiz olacaktýr.</li>\n".
                      "<li>Bir kategorinin ismini görevleri karýþtýrmadan deðiþtirebilirsiniz.</li>\n".
                      "<li>Ýki görev grubu ayný ada sahip olamaz.</li></ul>\n";

$usergroup_info =   "<ul><li>Eðer bir kullanýcý grubunu silerseniz onunla ilgili tüm özel forum mesajlarý da silinecektir.</li>\n".
                      "<li>Özel kullanýcý gruplarý sadece sözkonusu grubun üyeleri tarafýndan görülebilirler.</li>\n".
                      "<li>Bir kullanýcý grubunun adýný içindeki kullanýcýlarý karýþtýrmadan deðiþtirebilirsiniz.</li>\n".
                      "<li>Ýki kullanýcý grubu ayný ada sahip olamaz.</li></ul>\n";
