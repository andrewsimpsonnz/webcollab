...
$taskgroup_info =   "<ul><li>Si vous effaçez votre groupe de tâches, toutes les tâches de ce groupe seront déclassées.</li>\n".
...
$usergroup_info =   "<ul><li>Si vous effacez un groupe d'utilisateurs, toutes leurs contributions dans le forum vont aussi être détruites.</li>\n".
                     "<li> Les groupes d'utilisateurs privés ne peuvent être vus que par les membres appartenant au groupe privé.</li>\n".
                      "<li>Vous pouvez changer le nom de groupe d'utilisateurs sans modifier les utilisateurs.</li>\n".
                      "<li>Deux groupes d'utilisateurs ne peuvent avoir le même nom.</li></ul>\n";

$user_info      =    "Merci de sélectionner votre activité dans le menu à gauche.<br /><br />".
                      "Pour information :<br />".
                      "<ul>".
                      "<li>Des utilisateurs privés ne peuvent être vu que par les membres du même groupe d'utilisateurs.</li>\n".
                      ...
                      "<li>Un utilisateur peut s'éditer lui-même sans que l'administrateur ne soit mis au courant, cela économise du temps (et des emails)</li>\n".
                      "</ul>\n";
