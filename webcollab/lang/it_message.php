...
//common items
    ...
    $lang['no']                           = 'No';
    $lang['action']                       = 'Azione';
    $lang['task']                         = 'Attivit&agrave;';
    $lang['tasks']                        = 'Attivit&agrave;';
    $lang['project']                      = 'Progetto';
    $lang['info']                         = 'Info';
    $lang['bytes']                        = ' bytes';
    $lang['select_instruct']              = '(Usa ctrl per selezioni multiple, o per deselezionare)';
    $lang['member_groups']                = 'L\'utente &egrave; membro dei gruppi selezionati sotto (se esistenti)';
    $lang['login']                        = 'Login';
    $lang['error']                        = 'Errore';
...
//contacts
    ...
    $lang['contact_add_info']             = 'Se aggiungi un nome di azienda, questo sar&agrave; visualizzato al posto del nome utente.';
 ...
 //files
    ...
    $lang['files_assoc_task']             = 'Files associati a questa attivit&agrave;';
 ...
 //**
    ...
    $lang['max_file_sprt']                = 'Il file da inviare deve essere pi&ugrave; piccolo di %s kb.';
    $lang['file_submit']                  = 'Invia file';
    $lang['no_upload']                    = 'Nessun file &egrave; stato inviato.  Torna indietro e riprova.';
    $lang['file_too_big_sprt']            = 'La dimensione massima &egrave; %s bytes.  Il tuo invio &egrave; troppo grande ed &egrave; stato cancellato.';
...
//**
    ...
    $lang['invalid_date_sprt']            = 'La data del %s non &egrave; una data valida del calendario (Controlla il numero di giorni nel mese).  Torna indietro e riprova.';
 ...
 //taskgroups
    ...
    $lang['no_taskgroups']                = 'Nessun taskgroup &egrave; stato definito';
    $lang['manage_taskgroups']            = 'Gestisci taskgroups';
    $lang['taskgroups']                   = 'Taskgroups';
    $lang['taskgroup_dup_sprt']           = 'Il taskgroup \'%s\' esiste gi&agrave;.  Scegli un nuovo nome.';
 ...
 //usergroups
    ...
    $lang['no_usergroups']                = 'Nessun usergroups &egrave; stato definito';
    $lang['manage_usergroups']            = 'Gestisci usergroups';
    $lang['usergroups']                   = 'Usergroups';
    $lang['usergroup_dup_sprt']           = 'TLo usergroup \'%s\' esiste gi&agrave;.  Scegli un nuovo nome.';
 ...
 //**
    ...
    $lang['message_sent_maillist']        = 'In ogni caso il messaggio &egrave; anche copiato alla mailing list.';
    $lang['who_online']                   = 'Chi &egrave; online?';
    $lang['edit_details']                 = 'Edita dettagli utente';
    $lang['show_details']                 = 'Visualizza dettagli utente';
    $lang['user_deleted']                 = 'Questo utente &egrave; stato cancellato!';
    $lang['no_usergroup']                 = 'L\'utente non &egrave; un membro di usergroups';
    $lang['not_usergroup']                = '(Non &egrave; membro di nessun usergroup)';
    $lang['no_password_change']           = '(La tua password non &egrave; stata cambiata)';
    ...
    $lang['number_tasks_owned']           = 'Numero di attivit&agrave; gestite:';
    $lang['number_tasks_completed']       = 'Numero di attivit&agrave; completate:';
    ...
    $lang['owned_tasks']                  = 'Attivit&agrave; assegnate';
    $lang['invalid_email']                = 'Indirizzo email non valido';
    $lang['invalid_email_given_sprt']     = 'L\'indirizzo email \'%s\' non &egrave; valido.  Torna indietro e riprova.';
    $lang['duplicate_user']               = 'Utente duplicato';
    $lang['duplicate_change_user_sprt']   = 'L\'utente \'%s\' esiste gi&agrave;.  Cambia il nome.';
    $lang['value_missing']                = 'Parametro omesso';
    $lang['field_sprt']                   = 'Il campo per \'%s\' &egrave; stato omesso. Torna indietro e riprova.';
    ...
    $lang['user_activity']                = 'Attivit&agrave; utente';

  //tasks
    $lang['add_new_task']                 = 'Aggiungi nuova attivit&agrave;';
    $lang['priority']                     = 'Priorit&agrave;';
    $lang['parent_task']                  = 'Attivit&agrave; madre';
    ...
    $lang['task_name']                    = 'Nome attivit&agrave;';
    $lang['deadline']                     = 'Scadenza';
    $lang['taken_from_parent']            = '(Ereditato dal genitore)';
    $lang['status']                       = 'Stato';
    $lang['task_owner']                   = 'Assegnatario attivit&agrave;';
    ...
    $lang['group_edit']                   = 'Chiunque nello usergroup pu&ograve; editare?';
    $lang['project_description']          = 'Descrizione progetto';
    $lang['task_description']             = 'Descrizione attivit&agrave;';
    ...
    $lang['edit_task']                    = 'Edita attivit&agrave;';
    ...
    $lang['del_javascript_task_sprt']     = 'Questa operazione cancella l\'attivit&agrave; %s. Sei sicuro?';
...
//**
    ...
    $lang['percent_sprt']                 = '%d%% delle attivit&agrave; completate';
    ...
    $lang['percent_project_sprt']         = 'Questo progetto &egrave; completo al %d%%';
    $lang['owned_by']                     = 'Assegnato a';
    $lang['created_on']                   = 'Creato il';
    $lang['completed_on']                 = 'Completo il';
    $lang['modified_on']                  = 'Modificato il';
    $lang['project_on_hold']              = 'Il progetto &egrave; congelato';
    $lang['project_accessible']           = '(Questo progetto &egrave; accessibile da tutti gli utenti)';
    $lang['task_accessible']              = '(Questa attivit&agrave; &egrave; accessibile da tutti gli utenti)';
    $lang['project_not_accessible']       = '(Questo progetto &egrave; accessibile solo dai membri dello usergroup)';
    $lang['task_not_accessible']          = '(Questa attivit&agrave; &egrave; accessibile solo dai membri dello usergroup)';
    $lang['project_not_in_usergroup']     = 'Questo progetto non &egrave; assegnato ad uno usergroup ed &egrave; accessibile da tutti gli utenti.';
    $lang['task_not_in_usergroup']        = 'Questa attivit&agrave; non &egrave; assegnata ad uno usergroup ed &egrave; accessibile da tutti gli utenti.';
    $lang['usergroup_can_edit_project']   = 'Questo progetto pu&ograve; essere editato dai membri dello usergroup.';
    $lang['usergroup_can_edit_task']      = 'Questa attivit&agrave; pu&ograve; essere editata dai membri dello usergroup.';
    ...
    $lang['take_over_task']               = 'Acquisisco attivit&agrave;';
    $lang['task_info']                    = 'Informazioni attivit&agrave;';
    ...
    $lang['no_assigned']                  = 'Non ci sono attivit&agrave; incomplete assegnate a questo utente.';
    $lang['todo_list']                    = 'Lista ToDo';
    $lang['summary_list']                 = 'Lista di riepilogo';
    $lang['task_submit']                  = 'Invia attivit&agrave;';
